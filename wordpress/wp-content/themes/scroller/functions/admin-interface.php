...
/*-----------------------------------------------------------------------------------*/
/* Themnific Admin Interface - themnificthemes_add_admin */
/*-----------------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------------*/
/* Themnific Reset Function - themnific_reset_options */
/*-----------------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------------*/
/* Generates The Options - themnific_machine */
/*-----------------------------------------------------------------------------------*/
...
function themnificthemes_machine($options) {
	...
	foreach ($options as $value) {
		...
		case 'text':
			...
			if ( $std != "") { $val = $std; }
			$output .= '<input class="themnific-input" name="'. esc_attr( $value['id'] ) .'" id="'. esc_attr( $value['id'] ) .'" type="'. esc_attr( $value['type'] ) .'" value="'. esc_attr( $val ) .'" />';
		break;
		...
		case 'textarea':
			...
			if(isset($value['std'])) {
				...
				$output .= '<textarea class="themnific-input" name="'. esc_attr( $value['id'] ) .'" id="'. esc_attr( $value['id'] ) .'" cols="'. esc_attr( $cols ) .'" rows="8">'.esc_textarea( $ta_value ).'</textarea>';
		...
		case "color":
			$val = $value['std'];
			$stored  = esc_attr(get_option( $value['id'] ));
			if ( $stored != "") { $val = $stored; }
			$output .= '<div id="' . esc_attr( $value['id'] ) . '_picker" class="colorSelector"><div></div></div>';
			$output .= '<input class="themnific-color" name="'. esc_attr( $value['id'] ) .'" id="'. esc_attr( $value['id'] ) .'" type="text" value="'. esc_attr( $val ) .'" />';
		break;   
		...
		case "typography":
			...
			if (strpos($val, 'Roboto') !== false){ $font53 = 'selected="selected"'; }
			if (strpos($val, 'Source Sans Pro') !== false){ $font54 = 'selected="selected"'; }
			if (strpos($val, 'Arial Black') !== false){ $font55 = 'selected="selected"'; }
			if (strpos($val, 'Abril Fatface') !== false){ $font56 = 'selected="selected"'; }
			if (strpos($val, 'Montserrat') !== false){ $font57 = 'selected="selected"'; }
			if (strpos($val, 'Playfair Display') !== false){ $font58 = 'selected="selected"'; }
			if (strpos($val, 'ScalaSansBoldUpcase') !== false){ $font59 = 'selected="selected"'; }
			if (strpos($val, 'ScalaSansBold') !== false){ $font60 = 'selected="selected"'; }
			if (strpos($val, 'ScalaSansRegularUpcase') !== false){ $font61 = 'selected="selected"'; }
			if (strpos($val, 'ScalaSansRegular') !== false){ $font62 = 'selected="selected"'; }
			if (strpos($val, 'LetterwerkBold') !== false){ $font63 = 'selected="selected"'; }
			if (strpos($val, 'LetterwerkRegular') !== false){ $font64 = 'selected="selected"'; }
			if (strpos($val, 'LetterwerkThin') !== false){ $font65 = 'selected="selected"'; }
			if (strpos($val, 'LetterwerkLight') !== false){ $font66 = 'selected="selected"'; }
			...
			$output .= '<option value="Trebuchet MS"'. $font03 .'>Trebuchet</option>';
			$output .= '<option value="Georgia"'. $font04 .'>Georgia</option>';
			$output .= '<option value="Times New Roman"'. $font05 .'>Times New Roman</option>';
			$output .= '<option value="Tahoma"'. $font06 .'>Tahoma</option>';
			$output .= '<option value="Palatino"'. $font07 .'>Palatino</option>';
			$output .= '<option value="Helvetica Neue"'. $font08 .'>Helvetica*</option>';
			$output .= '<option value="Calibri"'. $font09 .'>Calibri*</option>';
			$output .= '<option value="Myriad Pro"'. $font10 .'>Myriad Pro*</option>';
			$output .= '<option value="Lucida Sans Unicode"'. $font11 .'>Lucida</option>';
			$output .= '<option value="Arial Black"'. $font12 .'>Arial Black</option>';
			$output .= '<option value="Gill Sans"'. $font13 .'>Gill Sans*</option>';
			$output .= '<option value="Geneva"'. $font14 .'>Geneva*</option>';
			$output .= '<option value="Impact"'. $font15 .'>Impact</option>';
			
			$output .= '<option value="Droid Serif"'. $font16 .'>Droid Serif***</option>';
			$output .= '<option value="Droid Sans"'. $font32 .'>Droid Sans***</option>';
			$output .= '<option value="Jockey One"'. $font17 .'>Jockey One***</option>';
			$output .= '<option value="Quicksand"'. $font18 .'>Quicksand***</option>';
			$output .= '<option value="Terminal Dosis"'. $font19 .'>Terminal Dosis***</option>';
			$output .= '<option value="Sansita One"'. $font20 .'>Sansita One***</option>';
			$output .= '<option value="Changa One"'. $font21 .'>Changa One***</option>';
			$output .= '<option value="Paytone One"'. $font22 .'>Paytone One***</option>';
			$output .= '<option value="Dorsa"'. $font23 .'>Dorsa***</option>';
			$output .= '<option value="Rochester"'. $font24 .'>Rochester***</option>';
			$output .= '<option value="Bigshot One"'. $font25 .'>Bigshot One***</option>';
			$output .= '<option value="Open Sans"'. $font26 .'>Open Sans***</option>';
			$output .= '<option value="Open Sans Condensed"'. $font45 .'>Open Sans Condensed***</option>';	
			$output .= '<option value="Merienda One"'. $font27 .'>Merienda One***</option>';
			$output .= '<option value="Six Caps"'. $font28 .'>Six Caps***</option>';
			$output .= '<option value="Bevan"'. $font29 .'>Bevan***</option>';
			$output .= '<option value="Oswald"'. $font30 .'>Oswald***</option>';
			$output .= '<option value="Vidaloka"'. $font31 .'>Vidaloka***</option>';
			$output .= '<option value="Josefin Sans"'. $font33 .'>Josefin Sans***</option>';
			$output .= '<option value="Dancing Script"'. $font34 .'>Dancing Script***</option>';
			$output .= '<option value="Abel"'. $font35 .'>Abel***</option>';
			$output .= '<option value="Rokkitt"'. $font36 .'>Rokkitt***</option>';	
			$output .= '<option value="Passion One"'. $font37 .'>Passion One***</option>';	
			$output .= '<option value="Bitter"'. $font38 .'>Bitter***</option>';	
			$output .= '<option value="Gudea"'. $font39 .'>Gudea***</option>';	
			$output .= '<option value="Marvel"'. $font40 .'>Marvel***</option>';	
			$output .= '<option value="Questrial"'. $font41 .'>Questrial***</option>';	
			$output .= '<option value="Patua One"'. $font42 .'>Patua One***</option>';	
			$output .= '<option value="Carrois Gothic"'. $font43 .'>Carrois Gothic***</option>';	
			$output .= '<option value="Archivo Black"'. $font44 .'>Archivo Black***</option>';	
			$output .= '<option value="Arbutus Slab"'. $font46 .'>Arbutus Slab***</option>';	
			$output .= '<option value="Merriweather"'. $font47 .'>Merriweather***</option>';		
			$output .= '<option value="Stint Ultra Condensed"'. $font48 .'>Stint Ultra Condensed***</option>';
			$output .= '<option value="Raleway"'. $font49 .'>Raleway***</option>';
			$output .= '<option value="Armata"'. $font50 .'>Armata***</option>';
			$output .= '<option value="Karla"'. $font51 .'>Karla***</option>';
			$output .= '<option value="BenchNine"'. $font52 .'>BenchNine***</option>';
			$output .= '<option value="Roboto"'. $font53 .'>Roboto***</option>';
			$output .= '<option value="Source Sans Pro"'. $font54 .'>Source Sans Pro***</option>';
			$output .= '<option value="Arial Black"'. $font55 .'>Arial Black*</option>';
			$output .= '<option value="Abril Fatface"'. $font56 .'>Abril Fatface***</option>';
			$output .= '<option value="Montserrat"'. $font57 .'>Montserrat***</option>';
			$output .= '<option value="Playfair Display"'. $font58 .'>Playfair Display***</option>';
			$output .= '<option value="ScalaSansBoldUpcase"'. $font59 .'>ScalaSansBoldUpcase***</option>';
			$output .= '<option value="ScalaSansBold"'. $font60 .'>ScalaSansBold***</option>';
			$output .= '<option value="ScalaSansRegularUpcase"'. $font61 .'>ScalaSansRegularUpcase***</option>';
			$output .= '<option value="ScalaSansRegular"'. $font62 .'>ScalaSansRegular***</option>';
			$output .= '<option value="LetterwerkBold"'. $font63 .'>LetterwerkBold***</option>';
			$output .= '<option value="LetterwerkRegular"'. $font64 .'>LetterwerkRegular***</option>';
			$output .= '<option value="LetterwerkThin"'. $font65 .'>LetterwerkThin***</option>';
			$output .= '<option value="LetterwerkLight"'. $font66 .'>LetterwerkLight***</option>';
			$output .= '</select>';
			...
			if($val == '400 italic'){ $italic = 'selected="selected"'; }
			...
			if($val == '700 italic'){ $bolditalic = 'selected="selected"'; }
...
/*-----------------------------------------------------------------------------------*/
/* Themnific Uploader - themnificthemes_uploader_function */
/*-----------------------------------------------------------------------------------*/
