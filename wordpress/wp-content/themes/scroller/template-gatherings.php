...
<div id="gatherings-filter" class="body3">
 
  <div class="container">
    
        <ul>
        
            <li><a class="current" href="<?php echo stripslashes(get_option('themnific_url_gatherings'));?>">
...
<div class="container container_alt"> 
  ...
  <div id="folio-wrap">
          ...
          <ul id="portfolio-list" class="loop">
              ...
              <?php query_posts( array( 'post_type' => 'gathering', 'paged' => $paged, 'posts_per_page' => 9));
